...
public class AddProductQuantityController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int productId=Integer.parseInt(request.getParameter("productId"+rowCount));		
		...
		boolean productQuantityUpdated=productService.updateVendorQuantity(productId, vendorId, quantity);
